 ...
 * This file demonstrates how to integrate Tezossmart with a web frontend
 */

// For React/Vue/Angular applications
export class TezossmartClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new TezossmartClient(provider, contractAddress);
